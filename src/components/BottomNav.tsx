...
export default function BottomNav() {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 inset-x-0 z-50 bg-white/95 dark:bg-brand-charcoal/95 backdrop-blur border-t border-brand-charcoal/10 dark:border-brand-sand/10"
    >
