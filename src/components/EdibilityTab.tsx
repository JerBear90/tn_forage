...
export default function EdibilityTab({
  ...
  return (
    <div className="mt-6 space-y-4" data-testid="edibility-tab">
      {/* Edibility badge */}
      <div>
        <span
      ...
      {/* Toxic lookalikes — ALWAYS appear FIRST */}
      {toxicLookalikes.length > 0 && (
        <div data-testid="edibility-toxic-lookalikes">
          ...
          >
            <p className="text-xs font-semibold text-red-700 dark:text-red-400 mb-2">
              Review these toxic lookalikes carefully before considering edibility.
            </p>
              ...
              {toxicLookalikes.map((la) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-semibold text-xs text-brand-charcoal dark:text-brand-sand">
