...
export const MUSHROOM_SLOTS: PhotoSlotConfig[] = [
  { key: 'top', label: 'Top', description: 'Cap surface from above', placeholderAlt: 'Example: photograph the mushroom cap from directly above', placeholderSrc: '/images/placeholders/mushroom-top.svg', required: true },
...
export const PLANT_SLOTS: PhotoSlotConfig[] = [
  { key: 'whole-plant', label: 'Whole Plant', description: 'Full plant view', placeholderAlt: 'Example: photograph the entire plant showing overall shape', placeholderSrc: '/images/placeholders/plant-whole.svg', required: true },
...
export const TREE_SLOTS: PhotoSlotConfig[] = [
  { key: 'whole-tree', label: 'Whole Tree', description: 'Full tree silhouette', placeholderAlt: 'Example: photograph the entire tree showing overall shape and canopy', placeholderSrc: '/images/placeholders/tree-whole.svg', required: true },
