...
function ComparisonModal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex flex-col bg-brand-sand dark:bg-dark-surface"
      role="dialog"
      aria-modal="true"
      aria-label="Species comparison"
    >
      {/* Modal header */}
      <div className="sticky top-0 z-10 bg-brand-sand/95 dark:bg-dark-surface/95 backdrop-blur-sm border-b border-brand-charcoal/10 dark:border-brand-sand/10 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={onClose}
            aria-label="Back to compare selection"
            className="shrink-0 flex items-center justify-center min-w-[44px] min-h-[44px] rounded-lg text-brand-charcoal/60 hover:text-brand-charcoal hover:bg-brand-charcoal/10 dark:text-brand-sand/60 dark:hover:text-brand-sand dark:hover:bg-brand-sand/10 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-teal"
          >
