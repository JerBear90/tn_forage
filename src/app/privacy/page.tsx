  ...
  return (
    <div className="p-4 pb-24 max-w-2xl mx-auto">
      ...
      <div className="prose prose-sm text-brand-charcoal/80 dark:text-brand-sand/80 space-y-4">
        <section>
          <h2 className="text-sm font-semibold text-brand-charcoal dark:text-brand-sand">1. Data We Collect</h2>
        ...
        <section>
          <h2 className="text-sm font-semibold text-brand-charcoal dark:text-brand-sand">2. How We Use Your Data</h2>
        ...
        <section>
          <h2 className="text-sm font-semibold text-brand-charcoal dark:text-brand-sand">3. Data Storage</h2>
        ...
        <section>
          <h2 className="text-sm font-semibold text-brand-charcoal dark:text-brand-sand">4. Analytics Opt-Out</h2>
        ...
        <section>
          <h2 className="text-sm font-semibold text-brand-charcoal dark:text-brand-sand">5. Data Export</h2>
        ...
        <section>
          <h2 className="text-sm font-semibold text-brand-charcoal dark:text-brand-sand">6. Account Deletion</h2>
        ...
        <section>
          <h2 className="text-sm font-semibold text-brand-charcoal dark:text-brand-sand">7. Third-Party Services</h2>
        ...
        <section>
          <h2 className="text-sm font-semibold text-brand-charcoal dark:text-brand-sand">8. Contact</h2>
